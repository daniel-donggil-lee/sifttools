...
## Pricing: Three Tiers, One Clear Winner

| Plan | Price | Minutes/Month | Exports | Key Features | Assessment |
|------|-------|--------------|---------|--------------|------------|
| Basic | Free | 600 | 3 | Speaker ID, real-time transcription | Enough for 2-3 meetings per week |
| Pro | $16.99/mo | 6,000 | Unlimited | Advanced search, custom vocabulary (limited), Zoom/Teams integration | The right plan for most professionals |
| Business | $30/mo | 6,000 | Unlimited | Custom vocabulary, admin controls, team features | Only if team management and custom terms are essential |

The Pro plan at $16.99/month provides 6,000 minutes (100 hours) of transcription. For a professional attending 20-25 meetings per week averaging 30-45 minutes each, that budget covers the full workload with room to spare.

The free plan's 600 minutes (10 hours) per month is generous enough for light use --- roughly 3-4 meetings per week. The 3-export limit is the real constraint; transcripts can be viewed in-app but only exported three times per month.

Rev's automated service at $0.25/minute would cost approximately $150/month for the same 600 minutes that Otter provides free. For real-time transcription specifically (not batch processing of recorded files), Otter's pricing is the most competitive in the market.
...
Otter.ai does meeting transcription better than any competing tool for English-language virtual meetings. The 95% accuracy on clear audio, automatic meeting join, and AI-generated summaries combine into a workflow that eliminates manual note-taking entirely. The $16.99/month Pro plan covers 100 hours of meetings --- enough for even the most meeting-heavy professionals. Custom vocabulary on the cheaper plans and stronger non-English support would make it a complete solution; as it stands, Otter is the best option for its core use case and limited outside of it.
